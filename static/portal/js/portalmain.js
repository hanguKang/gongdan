$(function() {
	...
	var sportsSlide = $(".sportsSlide").slick({
		accessibility : true,
		autoplay: false,
		autoplaySpeed:4000,
		//speed:500,
		...
		slidesToScroll: 1,
		arrows:true,
		prevArrow  : '.sportsSlideLt',
		nextArrow : '.sportsSlideRt',
		//slickPlay : '.b-play',
		//slickStop : '.b-stop',
		pauseOnFocus: true,
		pauseOnHover : true,
	...
	var welfareSlide = $(".welfareSlide").slick({
		accessibility : true,
		autoplay: false,
		autoplaySpeed:4000,
		//speed:500,
		...
		slidesToScroll: 1,
		arrows:true,
		prevArrow  : '.welfareSlideLt',
		nextArrow : '.welfareSlideRt',
		//slickPlay : '.b-play',
		//slickStop : '.b-stop',
		pauseOnFocus: true,
		pauseOnHover : true,
